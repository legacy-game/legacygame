...
namespace Legacy.World
{
    public static class WorldFactory
    {
        ...
        public static WorldState CreateVeyneSeedWorld(long worldSeed = 1001)
        {
            ...
            cafeInventory.Add(ItemCatalog.CoffeeBeans, 25);
            cafeInventory.Add(ItemCatalog.Milk, 12);
            cafeInventory.Add(ItemCatalog.PaperCup, 30);
            state.AddWorkplaceInventory(cafeInventory);
            var cafeStorage = new InventoryContainerState(new WorldEntityId("inv_linden_cafe_storage"), cafeWorkplaceId, InventoryContainerKind.WorkplaceStorage, "Linden Cafe storage");
            cafeStorage.TryAdd(ItemCatalog.CoffeeBeans, 25);
            cafeStorage.TryAdd(ItemCatalog.Milk, 12);
            cafeStorage.TryAdd(ItemCatalog.PaperCup, 30);
            state.AddInventoryContainer(cafeStorage);
            var cafeTill = new CashDrawerState(new WorldEntityId("cash_linden_cafe_till"), cafeWorkplaceId, CashContainerKind.Till, "Linden Cafe till drawer");
            cafeTill.Add(CashDenomination.TwentyDollar, 2);
            cafeTill.Add(CashDenomination.TenDollar, 3);
            cafeTill.Add(CashDenomination.FiveDollar, 6);
            cafeTill.Add(CashDenomination.OneDollar, 20);
            cafeTill.Add(CashDenomination.Quarter, 40);
            cafeTill.Add(CashDenomination.Dime, 30);
            cafeTill.Add(CashDenomination.Nickel, 20);
            cafeTill.Add(CashDenomination.Penny, 100);
            state.AddCashDrawer(cafeTill);
            var hollandWallet = new CashDrawerState(new WorldEntityId("cash_holland_wallet"), hollandId, CashContainerKind.Wallet, "Mr. Holland wallet");
            hollandWallet.Add(CashDenomination.FiveDollar, 2);
            hollandWallet.Add(CashDenomination.OneDollar, 5);
            hollandWallet.Add(CashDenomination.Quarter, 8);
            state.AddCashDrawer(hollandWallet);
            var pharmacyInventory = new WorkplaceInventoryState(pharmacyWorkplaceId);
            pharmacyInventory.Add(ItemCatalog.PharmacyStockBox, 8);
            state.AddWorkplaceInventory(pharmacyInventory);
            var bookshopInventory = new WorkplaceInventoryState(bookshopWorkplaceId);
            bookshopInventory.Add(ItemCatalog.NewspaperBundle, 10);
